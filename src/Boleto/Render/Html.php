...
class Html implements HtmlContract
{
     ...
     * @throws \Exception
     */
    public function gerarBoleto($layout = 'boleto')
    {
        ...
        return view('BoletoHtmlRender::'.$layout, [
            'boletos' => $this->boleto,
            'css' => $this->writeCss(),
